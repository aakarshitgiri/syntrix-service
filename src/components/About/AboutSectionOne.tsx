              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="24×7 Global SOC Operations" />
                    <List text="Automation-Driven Security" />
                    <List text="Cost-Effective Delivery" />
                  </div>

                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Expert Engineers & Analysts" />
                    <List text="Modern Tech Stack" />
                    <List text="Enterprise-Grade Solutions" />
                  </div>
                </div>
              </div>
            </div>
